...
class Penyelenggara extends AUTH_Controller
{
	...
	public function index()
	{
		...
		$data['datatpsnya']   	= $this->tps->select_by_tps();
		$data['userdata'] 		= $this->userdata;
		$data['page'] 			= "Data Pokok";
		$data['judul'] 			= "Data Pokok";
		$data['deskripsi'] 		= "Daftar desa penyelenggara pilpres serentak";
	...
	private function _validate()
	{
		...
		if ($this->input->post('kdtps') == '') {
			$data['inputerror'][] = 'kdtps';
			$data['error_string'][] = 'Kolom Tps tidak boleh kosong';
			$data['status'] = FALSE;
		}
