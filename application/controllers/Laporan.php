...
class Laporan extends AUTH_Controller
{
	...
	public function index()
	{
		...
		$data['page'] 			= "Laporan Hasil pilpres";
		$data['judul'] 			= "Laporan";
	...
	public function cetakPDF()
	{
		...
		$mpdf->WriteHTML($data);
		$mpdf->Output('./assets/excel/laporan_pilpres_' . $this->session->userdata('thn_data') . '.pdf', 'I');
	}
	...
	public function export()
	{
		...
		$objWriter->save('./assets/excel/laporan_pilpres_' . $this->session->userdata('thn_data') . '.xlsx');

		$this->load->helper('download');
		force_download('./assets/excel/laporan_pilpres_' . $this->session->userdata('thn_data') . '.xlsx', NULL);
	}
}
