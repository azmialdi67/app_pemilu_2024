...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="logo-container">
      <img class="logo-img" src="<?php echo base_url(); ?>assets/img/pilpres1.png" alt="Logo">
    </div>
    <div style="color: #fff;">
      <p>
        <center>Sistem Pemilihan Presiden Kabupaten Bandung</center>
      </p>
    </div>
