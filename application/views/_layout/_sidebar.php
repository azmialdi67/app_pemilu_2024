<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <!-- Kecamatan Only -->
      <li <?php if ($page == 'Hasil Pemilihan') {
            echo 'class="active"';
          } ?>>
      ...
      <li <?php if ($page == 'Laporan Hasil pilpres') {
            echo 'class="active"';
          } ?>>
        <a href="<?php echo base_url('laporan'); ?>">
          <i class="fa fa-table"></i>
          <span>Laporan Hasil pilpres</span>
        </a>
      </li>
      <?php
