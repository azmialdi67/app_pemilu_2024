    ...
    <div class="box-body">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">Tahapan Pelaksanaan pilpres</h3>
            </div>
            <div class="panel-body">
                <form id="form-tahapan" class="form-horizontal" method="POST">
                    <table class="">
                        <!-- Tahap 1 -->
                        <tr>
                            <td>Pengelolaan Data Desa Penyelenggara pilpres (input/edit/delete)</td>
                            <td>
                        ...
                        <!-- Tahap 2 -->
                        <tr>
                            <td>Pengelolaan Data Calon Presiden dan Wakil Preside (input/edit/delete)</td>
                            <td>
                        ...
                        <!--  Tahap 3 -->
                        <tr>
                            <td>Pengelolaan Hasil pilpres</td>
                            <td>
    ...
    <div class=" box-footer">
        ...
        <script>
            ...
            $('#btn-reset').click(function() { //button reset event click
                ...
                //if ('#cek1').val()=
                if ($('cek1').val() == '1') {
                    $('#cek1').bootstrapToggle('on')
                } else {
                    $('#cek1').bootstrapToggle('off')
                };
