        ...
        <div class="panel panel-primary">
            <div class="panel-body">
                <div class="col-md-6 col-xs-12">
                    <?php
                    echo '<h4 class="text-muted"><b>Daftar Calon Presiden dan Wakil Presiden Tahun ' . $this->session->userdata('thn_data') . '</b></h4>';
                    ?>
                </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body form">
                <form action="ajax_update()" id="form" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3">Nama Calon Presiden <small class="text-muted">(lengkap dengan gelar)</small></label>
                        <div class="col-md-9">
